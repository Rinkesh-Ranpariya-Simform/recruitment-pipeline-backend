...
/**
 * Query-string validation, coercion and defaulting.
 *
 ...
 * is a 400 with `details.status`, not an unfiltered 200. And `?pageSize=101`
 * is a 400, never a silent clamp — a client that asked for 500 rows and
