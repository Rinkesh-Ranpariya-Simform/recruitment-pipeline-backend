 ...
 * array and discards it — the BE-5 defect that made every
 * `400 VALIDATION_ERROR` carry `details: {}` (XFE-3, AC-B22). With
 * `noUncheckedIndexedAccess` on, the assignment must BIND: `??=` both creates
 * the bucket and hands back the array actually stored there.
 *
